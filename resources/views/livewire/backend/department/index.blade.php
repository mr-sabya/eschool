<div>
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">{{ $departmentId ? 'Edit' : 'Add' }} Department</div>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="save">
                        ...
                        <button class="btn btn-primary" type="submit">{{ $departmentId ? 'Update' : 'Save' }}</button>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">Department List</div>
                </div>
                <div class="card-body">
