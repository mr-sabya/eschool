<div>
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">{{ $bookCategoryId ? 'Edit' : 'Add' }} Book Category</div>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="save">
                        ...
                        <button class="btn btn-primary" type="submit">{{ $bookCategoryId ? 'Update' : 'Save' }}</button>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">Book Category List</div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="text-center">No book categories found.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this book category? This action cannot be undone.
                </div>
