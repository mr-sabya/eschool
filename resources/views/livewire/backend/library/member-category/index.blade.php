<div>
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">{{ $memberCategoryId ? 'Edit' : 'Add' }} Member Category</div>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" wire:model="duration_days" min="1">
                            @error('duration_days') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>

                        <button class="btn btn-primary" type="submit">{{ $memberCategoryId ? 'Update' : 'Save' }}</button>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">Member Category List</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $category->duration_days }} days</td>
                                    <td>
