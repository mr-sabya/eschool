<div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">
                        {{ $markDistributionId ? 'Edit' : 'Add' }} Mark Distribution
                    </div>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="save">
                        ...
                        <button class="btn btn-primary" type="submit">{{ $markDistributionId ? 'Update' : 'Save' }}</button>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="card-title m-0 text-white">Mark Distribution List</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $dist->name }}</td>
                                    <td>
                                        <button class="btn btn-sm btn-primary" wire:click="edit({{ $dist->id }})">
                                            <i class="ri-edit-line"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger" wire:click="confirmDelete({{ $dist->id }})" data-bs-toggle="modal" data-bs-target="#deleteModal">
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="text-center">No mark distributions found.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this mark distribution? This action cannot be undone.
                </div>
