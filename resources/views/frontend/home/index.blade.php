        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="top-header-left notice">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item menu-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item" title="শিক্ষকবৃন্দ" href="#">শিক্ষকবৃন্দ</a>
                                </li>
                                <li>
                        ...
                        <li class="nav-item menu-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item" title="শিক্ষকবৃন্দ" href="#">৬ষ্ঠ শ্রেণী</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item menu-item dropdown">
        ...
        <div class="container ">
            ...
            <div class="header">
                <div class="brand">
                    ...
                    <div class="text">
                        <p>Est. 1999</p>
                        <h1>Khulna Govt. High School, Khulna</h1>
                        <p>Sibbari mor, Khulna</p>
                    </div>
                </div>
                <div class="info">
                    <div class="contact">
                        <a href="#">+8801911663399</a>,
                        <a href="#">school@school.com</a>
                    </div>
                    <div class="socials">
                                ...
                                <div class="col-lg-7">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p> এ বিদ্যালয়টির প্রতিষ্ঠার ইতিহাস অস্পষ্ট। কারও মতে ১৮৫৬ সালে এ
                                                বিদ্যালয়টি
                                                প্রতিষ্ঠিত হয়, সেই হিসেবে এটি খুলনা শহরে প্রতিষ্ঠিত প্রথম স্কুল। আবার
                                                কারও মতে-
                                                এটি
                                                প্রতিষ্ঠিত হয় ১৮৭৩ সালে। এ হিসেবে খুলনা জিলা স্কুল শহরের প্রতিষ্ঠিত
                                                দ্বিতীয়
                                                স্কুল
                                                এবং প্রথমটি হলো খুলনার দৌলতপুরস্থ মুহসিন হাই স্কুল (১৮৬৭ ইং)।
                                                প্রতিষ্ঠাকালে
                                                "খুলনা
                                                জিলা স্কুল" এর নাম ছিল খুলনা হাইস্কুল। বাবু সাতুরাম মজুমদার তার নিজ অর্থ
                                                দিয়ে
                                                স্কুলের প্রথম পাকা ভবন তৈরি করেন। সেই সময় খ্যাতিমান শিক্ষক সারদা চরণ
                                                মিত্র
                                                ছিলেন
                                                প্রধান শিক্ষক।</p>
                                            ...
                                            <p> খুলনা জিলা স্কুল
                                                ১৮৮৩ সালের হান্টার কমিশনের রিপোর্ট
                                                <a href='#' class='readmore'></a><span style="text-align:right"><a
                                                        href="#">বিস্তারিত...</a></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="notice_box">
                        <marquee direction="up" scrollamount="3px" onmouseover="this.stop()" onmouseout="this.start()">
                            <ul>
                                ...
                                <li><a href="#">আগামী
                                        নির্বাচনী পরীক্ষা ৩১ মার্চের পরিবর্তে ৫ জুন অনুষ্ঠিত হবে</a></li>

                                <li><a href="#">আগামী
                                        ১২ এপ্রিল বিজ্ঞান বিভাগের পরীক্ষা</a></li>

                                <li><a href="#">আগামী
                                        ৩১ মার্চের মধ্যে সকল ফি পরিশোধ করতে হবে</a></li>

                                <li><a href="#">স্কুলের
                                        ভিতর মোবাইল ব্যবহার করা সম্পূর্ণ নিষেধ</a></li>

                                <li><a href="#">এই
                                        স্কুলের ডিজাইনটি ক্রয় করতে যোগাযোগ করুন : ০১৭৩২৬৬৭৩৬৪</a></li>

                                <li><a href="#">আমাদের
                                        শিক্ষা প্রতিষ্ঠানে আপনাদের স্বাগতম</a></li>
            ...
            <div class="root">
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-4 col-sm-4 root_01">
                        © All rights reserved © 2023 Educational </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 social-link">
                        <ul>
                            <li><a href="#" target="_blank"> <i class="fa-brands fa-facebook-f" target="_blank"></i></a>
                            </li>
                            <li><a href="#" target="_blank"> <i class="fa-brands fa-twitter"></i></a></li>
                            <li><a href="#" target="_blank"> <i class="fa-brands fa-google-plus"></i></a></li>
                            <li><a href="#" target="_blank"> <i class="fa-brands fa-youtube"></i></a></li>
                            <li><a href="#"><i class="fa-brands fa-instagram" target="_blank"></i></a>
                            </li>
                        </ul>
                    </div>
